...
```
To side-step that I did some googling and found [this handy guide](https://peterdaugaardrasmussen.com/2022/04/13/how-to-do-word-wrap-for-markdown-code/). All you need to do is include this chunk of CSS (?) code. 
...
```
and then wrape this HTML around your code chunk: 
